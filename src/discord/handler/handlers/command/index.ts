...
import { clone, getFilePaths } from "../../utils";
import { loadCommandsWithRest, registerCommands } from "./functions";
import type {
  CommandHandlerData,
...
export class CommandHandler {
  ...
  async reloadCommands(type?: ReloadOptions) {
    if (!this.#data.commandsPath) {
      throw new Error(
        'Cannot reload commands as "commandsPath" was not provided when instantiating Handler.'
      );
    }
